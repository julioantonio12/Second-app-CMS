...
export default function Slide(){
    const Slide01 = `${routeAPI}/mostrar-img/641.jpg`;
    //Creating dataset
    const dataSet = [
        [1, Slide01, "Lorem ipsum 1.", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", "5f6ffb04f3f60722797b8470"]
    ]
    //Executing datatable    
